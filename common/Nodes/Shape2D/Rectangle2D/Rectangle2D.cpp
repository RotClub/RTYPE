...
Types::Rect2 Rectangle2D::getDimensions() const { return dimensions; }

float Rectangle2D::getWidth() const { return dimensions.size.x; }

float Rectangle2D::getHeight() const { return dimensions.size.y; }

Types::Vector2 Rectangle2D::getOrigin() const { return dimensions.origin; }
...
Types::Rect2 Rectangle2D::getBoundingBox() const { return dimensions; }
