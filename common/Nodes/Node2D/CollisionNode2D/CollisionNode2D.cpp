...
CollisionNode2D::CollisionNode2D(const std::string& name) : collision_enabled(true), Node2D(name)
{
...
bool CollisionNode2D::isCollisionEnabled() const { return collision_enabled; }
