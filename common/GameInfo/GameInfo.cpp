...
GameInfo::GameInfo(const std::string &name, const std::string &description, const unsigned int max_players,
...
GameInfo::GameInfo(nlohmann::json &gameData) :
    _name(gameData["name"]), _description(gameData["description"]), _max_players(gameData["max_players"]), _authors({}),
